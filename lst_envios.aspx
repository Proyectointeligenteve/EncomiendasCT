...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="remodal" data-remodal-id="modalseguimiento" style="background-color:#013b63;font-size:14px !important">
       ...
       <div class="modal-body">
           ...
           <table style="background-color:white;width: 100% !important" id="tbSeguimiento" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped">
               <thead>
                   <tr>
   ...
   <div class="remodal" data-remodal-id="modalnuevoseg" style="background-color:#013b63;font-size:14px !important">
        ...
        <div class="remodal" data-remodal-id="deletemodal" style="background-color:#013b63;font-size:14px !important">
        <div class="modal-header">
            <h4>Eliminar</h4>
        </div>
        <div class="modal-body">
